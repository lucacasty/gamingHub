        ...
        case "team":
          for (let i = 0; i < teams.length; i++) {
            ...
            richiesta.done(function (data) {
              ...
              $("<li>").addClass("chat").addClass("list-group-item").prop("id", "li" + "t"+data[0].nome).attr("indice", "t" + data[0].nome).on("click", changeChosenChat).prop("title", data[0].nome).addClass("d-flex").addClass("justify-content-between").addClass("align-items-center").addClass("list-group-item-warning").append(
                $("<img>").prop("src", foto)
              ).append(
